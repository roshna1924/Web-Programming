            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result != null && result.size() > 0) {
                        ...
                        if(result.get(0).equalsIgnoreCase("hello") || result.get(0).equalsIgnoreCase("hi") || result.get(0).equalsIgnoreCase("hey")) {
                            ...
                            tts.speak("Oh, you have fever. Please take crocin medicine.",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:red;\">Speaker : Oh, you have fever. Please take crocin medicine.</p>"));
                        } else if(result.get(0).contains("don't know")) {
                            tts.speak("Then what you want me to suggest?",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:red;\">Speaker : Then what you want me to suggest?</p>"));
                        } else {
